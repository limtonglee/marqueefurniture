...
import {
  ...
  URL_EDIT_DESIGN_REQUIREMENT,
  URL_EDIT_DESIGN_REQUIREMENT_ROOM,
  URL_EDIT_DESIGN_REQUIREMENT_TAGS,
  URL_EDIT_DESIGN_REQUIREMENT_MB,
...
export const editDesignRequirement = (
  requirementId,
  requestType,
  floorplan1,
  floorplan2,
  ...
  return update(URL_EDIT_DESIGN_REQUIREMENT, body);
};

export const editDesignRequirementRoom = (
  roomSize,
  roomType,
  requirementId
) => {
  ...
  return update(URL_EDIT_DESIGN_REQUIREMENT_ROOM, body);
};

export const editDesignRequirementTags = (requirementId, requirementTagsId) => {
  const body = {
    requirementId: requirementId,
    requirementTagsId: requirementTagsId,
  };
